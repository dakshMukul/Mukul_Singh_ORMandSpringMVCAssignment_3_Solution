			...
			<tbody>
				<c:forEach items="${Customer}" var="tempCustomer">
					<tr>
						...
						<td><c:out value="${tempCustomer.email_id}" /></td>
						<td>
							<!-- Add "update" button/link --> <a
							href="/Customer_Management/updateCustomer?id=${tempCustomer.id}"
							class="btn btn-info btn-sm"> Update </a> 
							
							<!-- Add "delete" button/link -->
							<a
							href="/Customer_Management/deleteCustomer?id=${tempCustomer.id}"
